      ...
      <div className='headerTop'>
        ...
        <div className={clsx([about.headerAbout])}>
          <div className='container-fluid'>
            <div className='row'>
              <div className='col-xl-6 col-lg-6-col-md-12 col-sm-12' style={{ border: '1px solid black', width: '100%', height: '400px' }}></div>
              <div className='col-xl-6 col-lg-6-col-md-12 col-sm-12' style={{ marginTop: '20px', maxWidth: '100%' }}>
                <div className={clsx([about.aboutMain])}>
                  ...
                  <div style={{ display: 'flex', marginBottom: '20px' }}>
                    ...
                    <Link href={''}>
                      <button className={clsx([about.buttonAbout])} style={{ marginLeft: '164px', width: '200px' }}>
                        Gọi ngay
                      </button>
                    </Link>
                  </div>
                  <div style={{ display: 'flex', marginBottom: '20px' }}>
                    ...
                    <Link href={''}>
                      <button className={clsx([about.buttonAbout])} style={{ marginLeft: '20px', width: '200px' }}>
                        Gửi ngay
                      </button>
                    </Link>
                  </div>
                  <div style={{ display: 'flex', marginBottom: '20px' }}>
                    ...
                    <Link href={''}>
                      <button className={clsx([about.buttonAbout])} style={{ marginLeft: '188px', width: '200px' }}>
                        Nhắn ngay
                      </button>
                    </Link>
                  </div>
                  ...
                  <div style={{ marginBottom: '60px' }}>
                    ...
                    <div>
                      ...
                      <input
                        className={clsx([about.textAbout])}
                    ...
                    <input
                      style={{ width: '600px', height: '400px', border: '1px solid #e3e3e3', outline: 'none' }}
                      type='text'
                      placeholder='Lời nhắn'
                    />
                    <button style={{ border: 'none', backgroundColor: 'black', color: 'white', display: 'block', marginTop: '20px' }}>
                      Gửi ngay
                    </button>
                  </div>
                </div>
